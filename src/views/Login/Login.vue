      ...
      <div class="relative flex mx-auto min-h-100vh">
        ...
        >
          ...
          <div class="flex justify-center items-center h-[calc(100%-60px)]">
            ...
            >
              <img src="@/assets/svgs/login-box-bg.svg" key="1" alt="" class="w-300px" />
              <div class="text-3xl text-white flex justify-center items-center" key="2">{{
                t('login.welcome')
              }}</div>
              <div
                class="mt-5 font-normal text-white text-14px flex justify-center items-center"
                key="3"
              >
                {{ t('login.message') }}
              </div>
