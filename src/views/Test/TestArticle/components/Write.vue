...
const formSchema = ref<FormSchema[]>([
  {
    field: 'category_id',
    label: t('menuuser.category_id'),
    component: 'Select',
    componentProps: { remote: true, remoteMethod: searchTestCategory, options: testCategoryList }
  },
  { field: 'title', label: t('menuuser.title'), component: 'Input' },
  { field: 'content', label: t('menuuser.content'), component: 'InputTextarea' },
  { field: 'author', label: t('menuuser.author'), component: 'Input' },
  { field: 'password', label: t('menuuser.password'), component: 'InputPassword' },
  { field: 'is_published', label: t('menuuser.is_published'), component: 'Switch' },
  { field: 'view_count', label: t('menuuser.view_count'), component: 'Input' },
  { field: 'download_count', label: t('menuuser.download_count'), component: 'InputNumber' },
  { field: 'rating', label: t('menuuser.rating'), component: 'InputNumber' },
  {
    field: 'cover',
